...
mutation Insert($title: String, $content: String, $description: String, $imageUrl: String){
   insertBlog(title: $title, content: $content, description: $description, imageUrl: $imageUrl){
       blog_id
   }
 }
`);
  ...
  return (
    <div className="my-body">
      ...
      <div id="blogs" className="blog-content m-5">
        {Array.isArray(blogs) && blogs.length && blogs.map((blog, index) => {
          return (
            <>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="post">
                ...
                <input Style="width: 77%" type="text" id="title" onChange={(e) => setTitle(e.target.value)} />
                <hr />
                ...
                <input Style="width: 77%" type="text" id="content" onChange={(e) => setContent(e.target.value)} />
                <hr />
                <label htmlFor="img-url"> Image Url &nbsp;&nbsp;</label>
                <input Style="width: 77%" type="url" id="img-url" onChange={(e) => setUrl(e.target.value)} />
                <hr />
                <textarea
                  name="blog-content"
                  id="blog-content"
